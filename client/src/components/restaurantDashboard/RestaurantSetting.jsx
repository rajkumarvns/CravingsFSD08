...
const RestaurantSetting = ({ activeRestaurantId, refreshRestaurants, restaurants }) => {
  ...
  return (
    <>
      <div className="w-full max-w-5xl mx-auto py-4 px-4 sm:px-8 space-y-4">
        
        {/* Tabs for Settings */}
        <div className="flex justify-between items-center border-b border-gray-200 dark:border-gray-700 pb-2">
          <div className="flex gap-4">
            <button
              className={`font-semibold pb-2 border-b-2 transition-all ${activeTab === "user" ? "border-(--color-primary) text-(--color-primary)" : "border-transparent text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"}`}
              onClick={() => setActiveTab("user")}
            >
              User Profile
            </button>
            <button
              className={`font-semibold pb-2 border-b-2 transition-all ${activeTab === "restaurant" ? "border-(--color-primary) text-(--color-primary)" : "border-transparent text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"}`}
        ...
        {activeTab === "user" && (
          <div className="bg-white dark:bg-gray-800 shadow-2xl rounded-3xl overflow-hidden border border-gray-100 dark:border-gray-700 relative animate-in fade-in zoom-in-95 duration-300">
